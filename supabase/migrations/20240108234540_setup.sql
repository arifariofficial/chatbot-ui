...
AS $$
DECLARE
  project_url TEXT := 'https://snyqxrvdagcrxbnyzjfh.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNueXF4cnZkYWdjcnhibnl6amZoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNDcxMTI4NiwiZXhwIjoyMDQwMjg3Mjg2fQ.SLkvg3EGT4ZWIgBhLwJWaUK98VZ70JaQ4UK2Em__Swg'; -- full access needed for http request to storage
